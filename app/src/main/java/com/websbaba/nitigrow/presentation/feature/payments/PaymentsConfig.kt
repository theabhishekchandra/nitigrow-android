...
//
// The online flow (POST /payments/link → Cashfree) is fully wired end-to-end,
// but it cannot succeed until the Cashfree gateway clears merchant KYC /
...
//
// FLIP TO `true` the moment live Cashfree keys are set on the backend. No other
